...
@Deprecated(
        "Use @see io.mochadwi.util.mvvm#MediatorListLiveData instead to leverage collections accessible API.",
        ReplaceWith("MediatorListLiveData", "io.mochadwi.util.mvvm#MediatorListLiveData")
)
